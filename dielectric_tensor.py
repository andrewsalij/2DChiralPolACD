...
def fc_factor(huang_rhys,modes):
    '''Franck-Condon factor for array of vibronic modes and scalar Huang-Rhys factor. See (2.7) in Tempelaar, Roel, Excitonic and exciton-phonon interactions in molecular aggregates'''
