...
'''
Parsing for Q-Chem output files. Uses Pymatgen (https://doi.org/10.1016/j.commatsci.2012.10.028) for the bulk of parsing,
...
def read_vibronics(text_to_read):
    '''Parses vibronic data from text string. See pymatgen.io.qchem.utils '''
