...
def plot_double_set_colored_shared_y_axis(filename,x_axis,y_axis_stack,y_axis_set_color_values_stack,figure=  None,axis = None,
    ...
    st_fontsize = 7
    axes[0].set_title("a", fontsize=st_fontsize, x=.08, y=.85,weight ="bold")
    axes[1].set_title("b", fontsize=st_fontsize, x=.08, y=.85,weight= "bold")
...
def plot_quad_set_shared_axes(filename,x_axis,y_axis_stack,y_axis_set_color_values_stack,figure=  None,axis = None,x_label = None,y_label = None,opacity = 1,norm_max =1,norm_min = 0,colorbar_label = "",cmap = 'seismic',figsize = (6.6,6.6),**kwargs):
    ...
    sub_tit_y = .83
    st_fontsize = 7
    axes[0].set_title("a", fontsize=st_fontsize, x=sub_tit_x, y=sub_tit_y,weight = "bold")
    axes[1].set_title("b", fontsize=st_fontsize, x=sub_tit_x, y=sub_tit_y,weight = "bold")
    axes[2].set_title("c",fontsize =st_fontsize,x=sub_tit_x,y =sub_tit_y,weight = "bold")
    axes[3].set_title("d", fontsize=st_fontsize, x=sub_tit_x, y=sub_tit_y,weight= "bold")
    ...
    figure.subplots_adjust(left = .11,right = 0.99,bottom = .23,top = .99)

    if (to_make_single_x_label):
        plt.gcf().text(.54,.24,x_label,va='center',ha='center',fontsize = 7)
...
def plot_triple_set_di_bari(filename,x_axis,y_axis_stack,y_axis_set_color_values_stack,figure=  None,axis = None,x_label = None,y_label = None,opacity = 1,norm_max =1,norm_min = 0,colorbar_label = "",cmap = 'seismic',figsize = (6.6,6.6),**kwargs):
    ...
    plt.setp(axes[1].spines.values(), color=None)
    figure.set_size_inches(figsize)
    figure.subplots_adjust(hspace = 0.05)
    figure.subplots_adjust(wspace = 0)
    kwargs_no_cbar = kwargs.copy()
    ...
    sub_tit_x = .09
    sub_tit_y = .83
    subtitle_set = ["a","b","c","d"]
    sub_tit_fs = 7
    axes[0].set_title(subtitle_set[0], fontsize=sub_tit_fs , x=sub_tit_x, y=sub_tit_y ,weight= "bold")
    axes[1].set_title(subtitle_set[1], fontsize=sub_tit_fs , x=sub_tit_x-.04, y=sub_tit_y ,weight= "bold")
    axes[2].set_title(subtitle_set[2],fontsize =sub_tit_fs ,x=sub_tit_x,y =sub_tit_y ,weight= "bold")
    axes[3].set_title(subtitle_set[3], fontsize=sub_tit_fs , x=sub_tit_x, y=sub_tit_y ,weight= "bold")
    if (image_panel_b is not None):
        axes[1].imshow(image_panel_b)
        axes[1].text(.88,.75,"1",color = "black",transform= axes[1].transAxes,fontsize= 7)
        axes[1].text(.25,.4,"2",color = "red",transform= axes[1].transAxes,fontsize= 7)
        axes[1].text(.45,.7,"3",color = "blue",transform = axes[1].transAxes,fontsize= 7)
    ...
    plt.gcf().text(0.03,.44,y_label,va='center',ha='center',rotation = 'vertical',fontsize = 7)
